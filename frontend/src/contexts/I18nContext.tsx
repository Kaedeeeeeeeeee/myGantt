...
const translations: Record<Language, Record<string, string>> = {
  zh: {
    ...
    'feedback.content': '内容',
    'feedback.content.placeholder': '请详细描述您的反馈或建议...',
    'feedback.send': '发送反馈',
    'feedback.sending': '发送中...',
    'feedback.success.title': '反馈已发送',
    'feedback.success.message': '感谢您的反馈！邮件已成功发送，我们会尽快处理。',
    'feedback.error.send': '发送反馈失败，请稍后重试',
    'menu.feedback': '反馈',
    'feedback.user.info': '用户信息',
  ...
  en: {
    ...
    'feedback.content.placeholder': 'Please describe your feedback or suggestions in detail...',
    'feedback.send': 'Send Feedback',
    'feedback.sending': 'Sending...',
    'feedback.success.title': 'Feedback Sent',
    'feedback.success.message': 'Thank you for your feedback! Your email has been sent successfully and we will respond as soon as possible.',
    'feedback.error.send': 'Failed to send feedback, please try again later',
    'menu.feedback': 'Feedback',
    'feedback.user.info': 'User Info',
  ...
  ja: {
    ...
    'feedback.subject': '件名',
    'feedback.subject.placeholder': 'フィードバックの件名を入力',
    'feedback.content': '内容',
    'feedback.content.placeholder': 'フィードバックや提案を詳しく説明してください...',
    'feedback.send': 'フィードバックを送信',
    'feedback.sending': '送信中...',
    'feedback.success.title': 'フィードバックを送信しました',
    'feedback.success.message': 'フィードバックありがとうございます！メールが正常に送信されました。できるだけ早く対応いたします。',
    'feedback.error.send': 'フィードバックの送信に失敗しました。後でもう一度お試しください',
    'menu.feedback': 'フィードバック',
    'feedback.user.info': 'ユーザー情報',
