...
const translations: Record<Language, Record<string, string>> = {
  zh: {
    ...
    'feedback.success.message': '您的反馈已打开邮件客户端。请发送邮件以完成反馈提交。',
    'menu.feedback': '反馈',
  ...
  en: {
    ...
    'feedback.success.message': 'Your feedback has opened your email client. Please send the email to complete the feedback submission.',
  ...
  ja: {
    ...
    'feedback.success.message': 'フィードバックがメールクライアントで開きました。メールを送信してフィードバックの送信を完了してください。',
