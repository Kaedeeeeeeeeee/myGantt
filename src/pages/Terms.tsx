    ...
    <div className="legal-page">
      <div className="legal-content">
        ...
        <div className="legal-text">
          <p>
            本利用規約（以下「本規約」といいます。）は、myGantt（以下「当社」といいます。）が提供する
          ...
          <p>
            ...
            当社が本サービス上で掲載する本規約以外の規定は、本規約の一部を構成するものとします。
          </p>
          ...
          <p>
            ユーザーは、本サービスの有料プランに加入する場合、当社が別途定め、本サービス上に表示する利用料金を、
          ...
          <ul>
            ...
            <li>当社、ほかのユーザー、またはその他第三者のサーバーまたはネットワークの機能を破壊したり、
              妨害したりする行為</li>
          ...
          <p>
            前項各号のいずれかの事由に該当した場合、ユーザーは、当社に対して負っている債務の一切について当然に期限の利益を失い、
          ...
          <p>
            ...
            また、当社の過失（重過失を除きます。）による債務不履行または不法行為によりユーザーに生じた損害の賠償は、
          ...
          <p>
            当社はユーザーに対し、前項による本規約の変更にあたり、事前に、本規約を変更する旨および変更後の本規約の内容並びに
            その効力発生時期を通知いたします。
          </p>
